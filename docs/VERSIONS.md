...
Для проекта выполнена следующая обработка исходных файлов:

- выбор подходящих файлов из пакета;
- преобразование в моно, 48 кГц, OGG Vorbis;
- снижение уровня ниже −12 dBFS;
- добавление fade-in и fade-out для исключения щелчков на краях.

Перекодирование в проекте **не** выполняется: файлы лежат в `res/raw` ровно такими, какими были добавлены, и ни один шаг сборки их не трогает.
