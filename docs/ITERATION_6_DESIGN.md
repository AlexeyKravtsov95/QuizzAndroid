...
**Статус документа: ревизия 1.2, архитектурно утверждена, 2026-09-15.** Решения `I6-D*` приняты; решения владельца `O6-1`…`O6-6` подтверждены владельцем 2026-09-15; входные данные раздела 18.2 (иконки, сверка оставшихся строк-предложений) не получены и блокируют мерж своих PR. Реализация итерации 6 не начата. `I4-C6`, `I5-M5`, `I5-M6`, `I5-M10` не выполнены и остаются пунктами release-readiness итерации 7.
